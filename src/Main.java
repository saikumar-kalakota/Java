...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String d = cde.substring(1, 2); //c-> 0, d->1, e->2 ; as beginIndex =1 & endIndex =2 (excluded) only d is extracted.
        // No of characters extracted = Difference  of indexes
        // Eg: "smiles".substring(1, 5) returns "mile". 5-1= 4. Only 4 characters are printed starting from Index 1. Hence, m i l e.
        System.out.println(d);
        Optional<Map.Entry<Character, Long>> maxAppearedCharacter= mostFrequentCharacter("successes");
        System.out.println(maxAppearedCharacter);
    ...
    static Optional<Map.Entry<Character, Long>> mostFrequentCharacter(String word){
        Map<Character,Long> mapOfCharInt= word
                                            .chars()
                                            .mapToObj(c-> (char)c)
                                            .collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));

        System.out.println(mapOfCharInt);

        Optional<Map.Entry<Character, Long>> maxFreqCharacter = mapOfCharInt
                                                                .entrySet()
                                                                .stream()
    ...
    static Optional<Integer> maxValueInList(List<Integer> list){
